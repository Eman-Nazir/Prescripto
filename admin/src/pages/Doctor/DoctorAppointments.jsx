  ...
  return (
    <div className='w-full max-w-6xl m-5'>
         ...
         <div className='bg-white border border-gray-200 rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
                 ...
                 <div className='max-sm:hidden grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 py-3 px-6 border-b border-green-200'>
                       <p>#</p>
                       <p>Patient</p>
                       <p>Payment</p>
                       <p>Age</p>
...

        {
          appointments.map((item,index)=>(
              ...
              <div>
              <p className='text-xs inline border border-[var(--main-blue)] px-2 rounded-full'>{item.payment ? 'Online' : 'Cash'}</p>
              </div>
